...
from code_injector import h_process
...
arg_address = kernel32.VirtualAllicEx(h_process, 0, len(data), VIRTUAL_MEM, PAGE_EXECUTE_READWRITE)
written = c_int(0)
...
if not parameter:
    ...
    start_kernel32 = kernel32.GetProcAddress(h_kernel32, "LoadLibraryA")
